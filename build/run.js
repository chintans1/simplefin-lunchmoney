...
// clients/simpleFinClient.ts
function getClaimUrl(setupToken) {
  return atob(setupToken);
}
async function getSimpleFinAuth(claimUrl) {
...
async function getAccountsData(simpleFinAuth) {
...
async function run() {
  ...
  const claimUrl = getClaimUrl(demoToken);
